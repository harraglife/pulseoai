...
export async function POST(request: Request) {
  try {
    ...
    const contactToEmail = process.env.CONTACT_TO_EMAIL ?? "contact@pulseoai.fr";
    const contactFromEmail = process.env.CONTACT_FROM_EMAIL ?? "PulseoAI <contact@pulseoai.fr>";
