  ...
  return (
    <html lang="fr" className={`${poppins.variable} h-full antialiased`}>
      ...
      <body className="min-h-full flex flex-col bg-white text-navy font-sans pb-[68px] lg:pb-0">
        {/*
          Google Analytics 4 charge apres le chargement de la page (lazyOnload),
          hors du chemin critique, pour preserver le score PageSpeed.
        */}
        <Script
          src="https://www.googletagmanager.com/gtag/js?id=G-SCDJ15J0KC"
          strategy="lazyOnload"
        />
        <Script id="ga4" strategy="lazyOnload">
          {`window.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments);}gtag('js',new Date());gtag('config','G-SCDJ15J0KC');`}
        </Script>
