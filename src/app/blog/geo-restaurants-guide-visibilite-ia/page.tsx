          ...
          <div className="mx-auto max-w-3xl px-6 py-24 lg:py-28">
            ...
            <div className="mt-6 flex flex-wrap items-center gap-4 text-sm text-navy/50">
              <span className="inline-flex items-center gap-1.5">
                <Calendar className="size-4" />8 avril 2026
              </span>
              <span className="inline-flex items-center gap-1.5">
        ...
        <div className="mx-auto max-w-3xl px-6 py-12 lg:py-16">
          ...
          <div className="mt-16 border-t border-gray-200 pt-10">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <Link href="/blog/geo-hotels-guide-complet" className="rounded-xl border border-navy/10 p-5 hover:border-cyan/30 transition-colors">
                <p className="font-semibold text-navy">GEO pour les h&ocirc;tels : le guide complet 2026</p>
                <p className="mt-1 text-sm text-navy/60">Les 5 actions concr&egrave;tes pour rendre votre h&ocirc;tel visible sur ChatGPT et Gemini.</p>
              </Link>
              <Link href="/blog/geo-2026-pourquoi-votre-entreprise-ne-peut-plus-ignorer-les-moteurs-ia" className="rounded-xl border border-navy/10 p-5 hover:border-cyan/30 transition-colors">
                <p className="font-semibold text-navy">GEO en 2026 : pourquoi investir maintenant</p>
                <p className="mt-1 text-sm text-navy/60">Pourquoi le GEO est devenu indispensable pour votre entreprise.</p>
              </Link>
            </div>
          </div>
          ...
          <div className="mt-16 rounded-2xl bg-[#F8F9FA] p-8 text-center sm:p-12">
            ...
            <p className="mx-auto mt-3 max-w-xl text-navy/70">
              Demandez votre audit GEO gratuit. Nous analysons la visibilit&eacute; actuelle
