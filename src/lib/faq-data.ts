    ...
    items: [
      {
        ...
        answer:
          "Nos tarifs sont adaptés à la taille et aux besoins de chaque établissement. Nous proposons plusieurs formules à partir de quelques centaines d'euros par mois, accessibles aussi bien aux petits hôtels indépendants qu'aux groupes hôteliers. Le coût exact dépend du périmètre d'intervention : nombre de requêtes ciblées, volume de contenu, complexité technique et niveau de suivi souhaité. L'audit initial gratuit nous permet d'évaluer votre situation et de vous recommander la formule la plus adaptée. Contactez nous pour recevoir un devis personnalisé qui correspond précisément à vos objectifs et à votre budget.",
      },
      {
